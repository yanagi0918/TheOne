                    ...
                    <div class="bg-light rounded h-100 p-4">
                        ...
                        <% Event eventForUpdate = (Event) request.getAttribute("eventForUpdate"); %>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="adId" value="<%= eventForUpdate.getAdId() %>" readonly id="adId">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label">刊登公司統編</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="compId" value="<%= eventForUpdate.getCompIdAfterCompensate() %>" maxlength="8" required id="compId">
                                </div>
                            </div>
                            <div class="row mb-3">
