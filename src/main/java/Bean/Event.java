...
public class Event implements Serializable {
	...
	public String getCompIdAfterCompensate() {
		if (this.compId == 0) {
			return "00000000";
		}
		
		int digitsNumber = (int) Math.log10(this.compId) + 1;
        String compIdAfterCompensate = "";
        for(int i = 0; i < (8 - digitsNumber); i++){
        	compIdAfterCompensate += "0";
        }
        compIdAfterCompensate += this.compId;
        return compIdAfterCompensate;
	}
